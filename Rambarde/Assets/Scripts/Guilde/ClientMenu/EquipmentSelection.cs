...
public class EquipmentSelection : MonoBehaviour
{
    ...
    Characters.CharacterControl[] clients;
    ...
    {
        clientPanel.transform.GetChild(0).GetComponent<Text>().text = clients[selectedClientID].clientName;
        clientPanel.transform.GetChild(1).GetComponent<Image>().sprite = clients[selectedClientID].characterData.clientImage;
    ...
    public void Equip(int buttonId)
    {
        ...
        if (equipment.allowedType == clients[selectedClientID].characterData.charType && (equipment.numberOwned-equipment.numberEquiped) > 0)
        {
            // test equipment type
